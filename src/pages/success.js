...
export default function Success() {
  useEffect(() => {
    const sessionJson = sessionStorage.getItem("data")
      ? JSON.parse(String(sessionStorage.getItem("data")))
      : false
    if (!sessionJson) {
        ...
        <Container>
          <Row>
            ...
            <Col md={5}>
              ...
              <p>
                Please check your email for see the details on your oder and
                access you UPS Tracking Number
              </p>
